     ...
     function injectNewYearStyles() {
         ...
         style.textContent = `
             ...
             @media (max-width: 992px) {
                 ...
                 #newyear-products .ny-card { width: 250px; height: 420px; }
             }
             @media (max-width: 768px) {
                 ...
                 #newyear-products .ny-card { width: 220px; height: 400px; }
             }
             @media (max-width: 480px) {
                 ...
                 #newyear-products .ny-card { width: 200px; height: 380px; }
             }
             @media (max-width: 360px) {
                 ...
                 #newyear-products .ny-card { width: 180px; height: 360px; }
             }
         `;
     ...
     async function loadNewYearProducts() {
          ...
          try {
              ...
              if (activeProducts.length === 0) {
                  container.innerHTML = '<p class="text-center" style="padding: 40px; color: #64748B;">New Year deals are being updated. Check back soon!</p>';
                  return;
              }
              ...
              container.innerHTML = '<p class="text-center" style="padding: 40px;">Unable to load deals.</p>';
          }
     }
