     ...
     async function loadValentinesProducts() {
          ...
          try {
              ...
              if (activeProducts.length === 0) {
                  container.innerHTML = '<p class="text-center" style="grid-column: 1/-1; padding: 40px; color: #BE185D;">No Valentine\'s deals available. Please check back later or visit the admin panel to assign products to Valentine\'s Day sale.</p>';
                  return;
              }
              ...
              container.innerHTML = '<p class="text-center" style="grid-column: 1/-1; padding: 40px; color: #BE185D;">Error loading Valentine\'s deals. Please try again later.</p>';
          }
     }
